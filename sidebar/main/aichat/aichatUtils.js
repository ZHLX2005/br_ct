...
import { restoreLastPromptTemplate } from "../../../popup/main/prompts/lastPromptRestore.js";
...
export async function loadStoredData() {
  ...
  try {
    ...
    // lastPromptTemplate 写入端在 popup/main/prompts/promptsUI.js,归属 chrome.storage.sync
    ...
    // 恢复提示词选择 —— 走 popup/main/prompts/lastPromptRestore.js
